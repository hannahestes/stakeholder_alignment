    ...
    def generate_pareto_visualizations(self):
        ...
        for idx, rule in pareto_df.iterrows():
            ...
            for other_idx, other in pareto_df.iterrows():
                ...
                # Dominate: higher impact AND lower/equal complexity
                if other['impact'] >= rule['impact'] and other['complexity'] <= rule['complexity']:
                    if other['impact'] > rule['impact'] or other['complexity'] < rule['complexity']:
                        is_dominated = True
                        break
            if not is_dominated:
